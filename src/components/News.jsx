...
export class News extends Component {
    ...
    async componentDidMount() {
        let url = `https://newsapi.org/v2/top-headlines?country=in&apiKey=30ab8c67ce724d76869cb57bc81969b8&pageSize=${this.props.pageSize}`;
    ...
    handlePreviousPage = async () => {
        ...
        let url = `https://newsapi.org/v2/top-headlines?country=in&apiKey=30ab8c67ce724d76869cb57bc81969b8&pageSize=${this.props.pageSize}&page=${this.state.page - 1}`;
        this.setState({loading: true});
        let data = await fetch(url);
        let parsedData = await data.json();
        console.log(parsedData);
